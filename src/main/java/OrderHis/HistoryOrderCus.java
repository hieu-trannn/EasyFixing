 ...
 * @author delini
 */
public class HistoryOrderCus extends javax.swing.JPanel {
     ...
     */
    public HistoryOrderCus(int userid) {
    ...
    public void initTable() {
        ...
        try {
            ...
            Vector<Vector> data = dtb_query.getCustomerOrderHistory(idCustomer);
