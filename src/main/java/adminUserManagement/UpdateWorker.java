...
public class UpdateWorker extends javax.swing.JPanel {
     ...
     */
    public UpdateWorker(int userid) throws SQLException {
        initComponents();
        UserID = userid;
    ...
    public boolean updateInformation() throws SQLException {
        if (checkInfor()) {
            ...
            try {
                dtb_query.updateWorker(getUserID(),txtName.getText(), txtSpecifiedAddress.getText(), txtPhone.getText(),txtPass.getText(), txtEmail.getText(), txtCCCD.getText(), idWard,  dateFormated.format(jDateDoB.getDate()), txtAccountNum.getText(), txtExYear.getText());
                JOptionPane.showMessageDialog(this, "Update Worker successfully");
                return true;
