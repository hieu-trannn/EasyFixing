 ...
 * @author delini
 */
public class CustomerFinishFeedback extends javax.swing.JPanel {
     ...
     */
    public CustomerFinishFeedback(int userid) {
    ...
    public void initTable() {
        ...
        try {
            ...
            Logger.getLogger(CustomerFinishFeedback.class.getName()).log(Level.SEVERE, null, ex);
        }
