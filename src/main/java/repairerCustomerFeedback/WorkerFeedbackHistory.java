 ...
 * @author delini
 */
public class WorkerFeedbackHistory extends javax.swing.JPanel {
     ...
     */
    public WorkerFeedbackHistory(int userid) {
    ...
    public void initTable() {
        ...
        try {
            int idWorker = dtb_query.user2WorkerID(UserID);

            Vector<Vector> data = dtb_query.getWorkerListFeedback(idWorker);
            ...
            Logger.getLogger(WorkerFeedbackHistory.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        tableOrder.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer", "Service", "Comment", "Date", "Feedback"
            }
        ) {
