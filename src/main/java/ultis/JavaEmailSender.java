...
public class JavaEmailSender {
    ...
    public int sendRegisterPass(String receiverEmail) throws UnsupportedEncodingException {
        int code;
        code = generateRandomCode();
        String subject = "[EasyFixing] Register authentication code";
        String content = "Dear user,\n \nYou have signed up our EasyFixing - an app for Home Fixing. \nYour authentication code is: " + String.valueOf(code) + "\nYour code is valid in just 1 minute.\nPlease don't provide code for anyone! \nThank you for chosing us and welcome!\n \nAdmin";
        if (sendEmailMessage(receiverEmail, subject, content)) {
            return code;
        } else {
            return -1;
